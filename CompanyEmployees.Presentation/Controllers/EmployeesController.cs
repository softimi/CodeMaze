    ...
    public class EmployeesController : ControllerBase
    {
            ...
            (Guid companyId, [FromQuery] EmployeeParameters employeeParameters)
        {
            ...
            var pagedResult = await _service.EmployeeService
                .GetEmployeesAsync(companyId, employeeParameters, 
                trackChanges: false);
        ...
        {
            var employee = 
                await _service.EmployeeService.GetEmployeeAsync
        ...
        public async Task<IActionResult> CreateEmployeeForCompany
            (Guid companyId, [FromBody]
            EmployeeForCreationDto employee)
        {
            /*if (employee is null)
                return BadRequest("EmployeeForCreationDto" +
                    " object is null");
            ...
            [FromBody] EmployeeForUpdateDto employee)
        {
            ...
            await _service.EmployeeService
                .UpdateEmployeeForCompanyAsync(companyId, id, employee,
        ...
        public async Task<IActionResult>
            PartiallyUpdateEmployeeForCompany(Guid companyId, Guid id,
        [FromBody] JsonPatchDocument<EmployeeForUpdateDto> patchDoc)
        {
            if (patchDoc is null)
                return BadRequest(
                    "patchDoc object sent from client is null."
                    );
            ...
            await _service.EmployeeService
                .SaveChangesForPatchAsync(result.employeeToPatch,
